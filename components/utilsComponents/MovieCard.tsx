...
export const MovieCard = ({poster_path, title, release_date, vote_average}: MovieCardProps) => {
  const percentage = Math.round(vote_average *10)
  return (
    <article className='bg-[#262626] w-[350px] h-[600px] mx-auto rounded-lg text-white'>
